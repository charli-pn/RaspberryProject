...
<div class="row">
    ...
    <div class="col s12 m6">
        <ul class="collection with-header">
            <li class="collection-header"><h4><?= $albumToDisplay->get_title() ?></h4></li>
            <?php
            foreach ($songsToDisplay as $song) {
                $songTitle = $song->get_title();
                ?>
                <li class="collection-item"><div><?= substr($songTitle, 0, strripos($songTitle, '.')) ?><a href="#!" class="secondary-content"><i class="material-icons">play_arrow</i></a></div></li>
                            <?php
                        }
                        ?>
        </ul>
